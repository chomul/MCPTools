...
{
    /// <summary>
    /// 1단계 에셋 리스트업 창입니다. (메뉴: Tools/AI Asset Pipeline/1. Asset Listup)
    ...
    public class AssetListupWindow : EditorWindow
    {
        ...
        private const string PrefKeySelectedAi = "AIAssetPipeline.AssetListup.SelectedAiTool";
        private const string PrefKeyCustomCommand = "AIAssetPipeline.AssetListup.CustomAiCommand";
        private const string PrefKeyTimeout = "AIAssetPipeline.AssetListup.AiTimeoutSeconds";
        private const string PrefKeyAllowExplore = "AIAssetPipeline.AssetListup.AiAllowProjectExplore";
        private const string PrefKeyManualFoldout = "AIAssetPipeline.AssetListup.ManualFoldout";
        private const string PrefKeyExtractFromDoc = "AIAssetPipeline.AssetListup.ExtractFromDoc";
        ...
        [MenuItem("Tools/AI Asset Pipeline/1. Asset Listup", false, 1)]
        ...
        private void RefreshAssetListPaths()
        {
            ...
            _assetListPaths = AIAssetPipelineFolders.FindDocuments(
                DocsRootPath(), AIAssetPipelineFolders.AssetListFolder, "AssetList_*.json");
        ...
        private void Import(bool merge)
        {
            if (_owner == null)
            {
                EditorUtility.DisplayDialog("AI 응답 불러오기",
                    "에셋 리스트업 창을 찾을 수 없습니다. Tools/AI Asset Pipeline/1. Asset Listup 창을 연 뒤 다시 시도해주세요.", "확인");
                return;
            }
