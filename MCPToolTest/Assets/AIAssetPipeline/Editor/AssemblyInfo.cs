...
// AIAssetPipeline.Editor 어셈블리의 internal 멤버를 EditMode 테스트 어셈블리에 공개합니다.
//
// 이유 (Task 9 Q2):
//   테스트 대상 중 AIAssetPipelineFolders(Editor/Common/AIAssetPipelineFolders.cs)와
...
//
// 주의:
//   - 대상 어셈블리 이름은 Tests/EditMode/AIAssetPipeline.Editor.Tests.asmdef 의 "name" 값과 반드시 일치해야 합니다.
...
[assembly: InternalsVisibleTo("AIAssetPipeline.Editor.Tests")]
