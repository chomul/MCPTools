...
namespace AIAssetPipeline.Editor
{
    ...
    public static class SpriteSheetClipBuilder
    {
        ...
        public static string ControllerPathForSheet(string sheetPath)
        {
            ...
            string folder = $"{AIAssetPipelineFolders.AnimationsDir(AIAssetPipelineSettings.GetOrCreate())}/{sheetName}";
        ...
        public static SpriteSheetClipPlan Scan(string sheetPath)
        {
            ...
            plan.outputFolder = $"{AIAssetPipelineFolders.AnimationsDir(AIAssetPipelineSettings.GetOrCreate())}/{plan.sheetName}";
            ...
            string targetPrefabPath, string targetObjectPath)
        {
            ...
            if (!AIAssetPipelineFolders.EnsureAssetFolder(plan.outputFolder) &&
                !AssetDatabase.IsValidFolder(plan.outputFolder))
            {
                throw new InvalidOperationException(
                    ...
                    "조치: AIAssetPipelineSettings의 생성 결과 루트(generatedRootPath)를 확인해주세요.");
            }
        ...
        private static bool LinkPrefab(SpriteSheetClipBuildResult result, AnimatorController controller)
        {
            ...
            Undo.RecordObject(animator, "AIAssetPipeline 애니메이터 컨트롤러 연결");
