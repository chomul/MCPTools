            ...
            bool allowReadTools = false, string workingDirectory = null)
        {
            ...
            switch (command)
            {
                ...
                case "codex":
                    ...
                    tempOutputFile = Path.Combine(Path.GetTempPath(), $"aiassetpipeline_codex_out_{Guid.NewGuid():N}.txt");
                ...
                case "copilot":
                    useStdin = false;
                    tempPromptFile = Path.Combine(Path.GetTempPath(), $"aiassetpipeline_prompt_{Guid.NewGuid():N}.txt");
