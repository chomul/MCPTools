...
namespace MCPTools.Editor
{
    ...
    public class PromptTemplate
    {
        ...
        /// <see cref="MCPToolSettings.InstallRoot"/> 기준으로 계산하므로 MCPTools 폴더 위치와 무관하게 동작합니다.
        ...
        {
            get { return MCPToolSettings.InstallRoot + "/Editor/PromptBuilder/Templates"; }
        }

        /// <summary>
        /// 사용자 템플릿 폴더 경로입니다 (고정: "Assets/MCPTools.User/Templates").
        /// 항상 프로젝트의 Assets 아래에 있어 UPM(읽기 전용 패키지) 설치에서도 자유롭게
        /// 템플릿을 추가·수정할 수 있으며, 패키지 폴더와 이름이 겹치면 이 폴더의 템플릿이 우선합니다.
        /// </summary>
        public const string UserTemplatesFolder = "Assets/MCPTools.User/Templates";
